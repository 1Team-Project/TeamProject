					...
					<div class="c_select">
						<div class="innerselect">
							<label class="check"> <input type="checkbox"
								id="checkall" checked="">전체선택
							</label>
							<button type="button" class="btn_delete" id="delete">장바구니
								삭제</button>
							<script>
								...
								<li>
									<div class="item">
										<label class="check" for=""> <input type="checkbox"
											class="checkone" data-cartnum="${CartListVO.c_cartnumber}">
										</label>
										<div class="c_name">
											<div class="innername">
										...
										<div class="goods">
											...
											<div class="price">
												<div class="in_price">
													<span class="selling"> <input type="hidden"
														value="${CartListVO.p_price}" name="price"> <input
														type="text" readonly
														value="${CartListVO.p_price * CartListVO.c_count}"
														class="total"
														style="border: none; width: 50px; height: 50px; text-align: center; font-weight: 700;">
													</span> <span class="unit">원</span>
												</div>
												<div class="stamper count">
													<button type="button" class="btn minus off"
														onclick="plus_minus($(this).next(),'minus')">감소</button>
													<input type="number" id="stepperCounter" class="num"
														readonly="" value="${CartListVO.c_count}">
													<button type="button" class="btn plus"
														onclick="plus_minus($(this).prev(),'plus')">추가</button>
												</div>
											</div>
										</div>
									</div>
					...
					<div class="innerresult" style="top: 60px;">
						<div class="amount_view">
							<dl class="amount">
								...
								<dd class="price">
									<span class="num"> </span> <span class="unit">원</span>
								</dd>
							</dl>
						</div>
						...
						<div class="box">
							<ul class="list">
								<li>
									<div class="item">
										<label class="check" for=""> <input type="checkbox"
											class="checkone" name="cartVO[${i}].c_cartnumber"
											value="${CartListVO.c_cartnumber}"
											data-cartnum="${CartListVO.c_cartnumber}"> <c:set
												var="i" value="${i+1}" />
										</label>
										<div class="c_name">
											<div class="innername">
										...
										<div class="goods">
											<a href="#" class="c_img "><img
												src="${CartListVO.urllink}" /></a>
											<div class="price">
												<div class="in_price">
													<span class="selling"> <input type="hidden"
														value="${CartListVO.p_price}" name="price"> <input
				...
				<div class="cart_result">
					<div class="innerresult" style="top: 60px;">
						...
						<div class="btn_submit">
							...
							<input type="hidden" name="u_userid" id="u_userid"
								value="<sec:authentication property="principal.campusUser.u_userid"/>">
