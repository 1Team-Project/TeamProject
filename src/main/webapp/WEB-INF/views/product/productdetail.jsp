            ...
            <colgroup>
               ...
               <tbody>
                  ...
                  <tr>
                     <td class="price"><fmt:formatNumber value="${vo.p_price}"
                           pattern="###,###,###"></fmt:formatNumber>
                             <input type="hidden" value="${vo.p_price}" name="price">
                           </td>
                  </tr>
                  ...
                  <tr>
                     ...
                     <td>
                     <select>
                           <option value="" class="option">${vo.po_option1}</option>
                           <option value="" class="option">${vo.po_option2}</option>
                           <option value="" class="option">${vo.po_option3}</option>
                      </select>
...
<%--                         <fmt:formatNumber value="${vo.p_price}" pattern="###,###,###"></fmt:formatNumber></span>  --%>
                        <input type="text" name="sum" class="subtotal" readonly style="border: none;">+배송비
                  ...
                  <input type="hidden" id="p_number" value="${vo.p_number}">
                    <input type="hidden" name="userid" id="userid"
                     ...
                     <button type="button" class="btn btn-secondary btn-lg" onclick="location.href='/payment/paymentpage'">구매하기</button>
                  </div>
                              ...
                              <div class="p_reviewbar">
                                 <h1>
                                    <span class="rivew">Product's Review</span><br> <span
                                       class="star">평균 별점 : <input type="text" readonly style="border:none; width:30; height : 30;"></span>
                                 </h1>
                                 <div class="row">
                                 ...
                                 <table class="table">
                                    ...
                                    <tbody class="textcenter">
                                       <tr>
                                          ...
                                          <td>${r.rownum}</td>
                                          <td>${r.b_sort}</td>
                                          <td><a href="${r.rownum}" class="blacktext hoverthema clickview">${r.b_title}</a></td>
                                          <td>${r.b_writer}</td>
                                          <td>
