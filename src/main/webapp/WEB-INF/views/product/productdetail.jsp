			...
			<div class="p_info">
				<table>
					...
					<tbody>
						...
						<tr>
							<th><img src="/resources/main/images/choices.png">&nbsp;선택</th>
							<td><select>
						...
						<div class="price">
							<strong class="tot">총 상품금액 : </strong> <span class="sum">
								<span class="num"> <%-- 								<fmt:formatNumber value="${vo.p_price}" pattern="###,###,###"></fmt:formatNumber></span>  --%>
									<input type="text" name="sum" class="subtotal" readonly style="border: none;">+3000
...
<script>
	...
	$(".btn-secondary").click(function(e) {
		...
		$.ajax({
			...
			success : function() {
				var cart = confirm("상품을 바로 구매하시겠습니까?");
				if (cart) {
					location.href = "/payment/paymentpage?u_userid=" + userid;
				}
			},
			error : function() {
				alert("구매하기 실패");
